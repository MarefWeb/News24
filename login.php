...
<html lang="en">
    ...
    <body>
        ...
        <main class="main login">
            <form action="/includes/users/login.php" method="POST" class="form active" id="form">
                <div class="form__inner">
                    <p class="form__title">Вхід</p>
                    <?php
                        if($_GET['exists']) {
                    ...
                    <a href="/register.php" class="annotation">Зареєструватися</a>
                </div>
            </form>
        </main>
    </body>
